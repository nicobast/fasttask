...
setwd(paste(home_path,'/PowerFolders/Paper_MINDdata_fasttask',sep=''))
...
dependent_var_data<-data.frame(rbind(taskdur,hits,validrt,validpd,
...
path_figure3 <- paste(getwd(),'/figures/figure3_DV_distribution.tiff',sep='')
...
g4<-ggplot(lmm_contrast_data,aes(x=interaction(group3,typeGame)))+
  ...
  geom_text(aes(label = 'low-utility condition', x = 2, y = min(asymp.LCL)-0.2))+ 
  geom_text(aes(label = 'high-utility condition', x = 5, y = min(asymp.LCL)-0.2))+
  ...
  path_figure4 <- paste(getwd(),'/figures/figure4_RT_groups.tiff',sep='')
...
```{r plot_figure2_PD, echo=FALSE, fig.width=7, fig.height=3.5, fig.cap="(ref:figure-caption-3)"}
...
path_figure5 <- paste(getwd(),'/figures/figure5_arousal_regulation_of_reaction_time.tiff',sep='')
...
```{r plot_figure3_RTbyPD, echo=FALSE, fig.width=7, fig.height=4, fig.cap="(ref:figure-caption-4)"}
...
path_figure6 <- paste(getwd(),'/figures/figure6_arousal_change_byGroup.tiff',sep='')
...
```{r plot_figure3, fig.cap="(ref:figure-caption-5)", fig.height=3, fig.width=7}
